...
options:
  ...
  runtime:
    ...
    default: null
    choices: [ 'nodejs', 'nodejs4.3', 'java8', 'python2.7' ]
  role_arn:
    description:
...
def main():
    ...
    argument_spec.update(dict(
        ...
        runtime=dict(type='str', choices=['nodejs','nodejs4.3','java8','python2.7'], default=None),
    ...
    if state == 'present' and current_function:
        ...
        # We're done
        module.exit_json(changed=changed, result=response)
